...
export class QueryService {
	public static getInstance(init: QueryServiceInit = {}): QueryService {
		const endpointUrl = init.endpointUrl ?? 'https://localhost:8834/proxy/wdqs/bigdata/namespace/wdq/sparql';
	...
	private constructor(init: QueryServiceInit = {}) {
		this.endpointUrl = init.endpointUrl ?? 'https://localhost:8834/proxy/wdqs/bigdata/namespace/wdq/sparql';
